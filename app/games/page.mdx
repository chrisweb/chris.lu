...
export const metadata = {
    title: 'Games',
    description: 'My gaming history told through the hardware I owned, from the Amstrad CPC 6128, SNES, Nintendo 64 and SEGA Saturn to my long line of PCs.',
    alternates: {
...
<SectionJsonLd title={metadata.title} description={metadata.description} path="/games" />
...
After the SNES, the next console I got was the [Nintendo 64](https://en.wikipedia.org/wiki/Nintendo_64). Of course Mario Kart 64 was the first game I played and I was surprised to see how much it had evolved in comparison with the SNES version from 5 years before
...
<div className="grid">
    ...
    <div>
        ...
        [Fallout 4](https://en.wikipedia.org/wiki/Fallout_4) was not the best Fallout but the one I played the most, for the simple reason that I spent countless hours building my own Vault and Settlement. My vault was a great place to display all the comic books and Power Armors I had collected
    </div>
    <div>
