...
<div className="grid">
    ...
    <div>
        ![banner image display a game screen from the Amstrad Outrun game](../../public/assets/images/app/games/amstrad_outrun.png)
        [Outrun](https://en.wikipedia.org/wiki/Out_Run)
    </div>
</div>
...
<div className="grid">
    ...
    <div>
        ![banner image display a game screen from the MS-DOS Lemmings game](../../public/assets/images/app/games/msdos_lemmings.png)
    ...
    <div>
        ![banner image display a game screen from the MS-DOS Doom game](../../public/assets/images/app/games/msdos_doom.png)
    ...
    <div>
        ![banner image display a game screen from the MS-DOS Command & Conquer game](../../public/assets/images/app/games/msdos_command_and_conquer.png)
...
<div className="grid">
    ...
    <div>
        ![banner image display a game screen from the Half-Life game](../../public/assets/images/app/games/half-life.png)
        [Half-Life](https://en.wikipedia.org/wiki/Half-Life_(video_game))
    </div>
    <div>
        ![banner image display a game screen from the SimCity 3000 game](../../public/assets/images/app/games/simcity_3000.png)
        [SimCity 3000](https://en.wikipedia.org/wiki/SimCity_3000)
    </div>
    <div>
        ![banner image display a game screen from the Grand Theft Auto Vice City game](../../public/assets/images/app/games/grand_theft_auto_vice_city.png)
        [Grand Theft Auto Vice City](https://en.wikipedia.org/wiki/Grand_Theft_Auto:_Vice_City)
    </div>
    <div>
        ![banner image display a game screen from the Unreal Tournament 2004 game](../../public/assets/images/app/games/unreal_tournament_2004.png)
...
<div className="grid">
    <div>
        ![banner image display a game screen from the World of Warcraft game](../../public/assets/images/app/games/world_of_warcraft.png)
    ...
    <div>
        ![banner image display a game screen from the The Burning Crusade expansion](../../public/assets/images/app/games/the_burning_crusade.png)
    ...
    <div>
        ![banner image display a game screen from the Wrath of the Lich King expansion](../../public/assets/images/app/games/wrath_of_the_lich_king.png)
    ...
    <div>
        ![banner image display a game screen from the Cataclysm expansion](../../public/assets/images/app/games/cataclysm.png)
...
<div className="grid">
    <div>
        ![banner image display of my work on new PC](../../public/assets/images/app/games/pc01.jpg)
    </div>
    <div>
        ![banner image display of my work on new PC](../../public/assets/images/app/games/pc02.jpg)
    </div>
    <div>
        ![banner image display of my work on new PC](../../public/assets/images/app/games/pc03.jpg)
    </div>
    <div>
        ![banner image display of my work on new PC](../../public/assets/images/app/games/pc04.jpg)
    </div>
</div>

![banner image display of my work on new PC](../../public/assets/images/app/games/pc05.jpg)
...
<div className="grid">
    <div>
        ![banner image display a game screen from the World of Warcraft game](../../public/assets/images/app/games/fallout_3.png)
        [Fallout 3](https://en.wikipedia.org/wiki/Fallout_3) is my favorite Fallout game so far, the story and atmosphere were great
    </div>
    <div>
        ![banner image display a game screen from the Left 4 Dead 2 game](../../public/assets/images/app/games/left_4_dead_2.png)
        [Left 4 Dead 2](https://en.wikipedia.org/wiki/Left_4_Dead_2) is a game I had a lot of fun playing with my co-workers
    </div>
    <div>
        ![banner image display a game screen from Battlefield Bad Company 2 Vietnam game](../../public/assets/images/app/games/battlefield_bad_company_2_vietnam.png)
    ...
    <div>
        ![banner image display a game screen from the Civilization V game](../../public/assets/images/app/games/civilization_v.png)
    ...
    <div>
        ![banner image display a game screen from the Fallout 4 game](../../public/assets/images/app/games/fallout_4.png)
    ...
    <div>
        ![banner image display a game screen from the XCOM 2 game](../../public/assets/images/app/games/xcom_2.png)
        [XCOM 2](https://en.wikipedia.org/wiki/XCOM_2)
    </div>
    <div>
        ![banner image display a game screen from the Stardew Valley game](../../public/assets/images/app/games/stardew_valley.png)
        [Stardew Valley](https://en.wikipedia.org/wiki/Stardew_Valley)
    </div>
    <div>
        ![banner image display a game screen from the Rimworld game](../../public/assets/images/app/games/rimworld.png)
        [Rimworld](https://en.wikipedia.org/wiki/RimWorld)
    </div>
    <div>
        ![banner image display a game screen from the Anno 1800 game](../../public/assets/images/app/games/anno_1800.png)
