...
<div className="grid">
    ...
    <div>
        ![banner image display a game screen from the MS-DOS Super Mario Kart game](../../public/assets/images/app/games/msdos_maniac_mansion.png)
    ...
    <div>
        ![banner image display a game screen from the MS-DOS Street Fighter II game](../../public/assets/images/app/games/msdos_the_secret_of_monkey_island.png)
    ...
    <div>
        ![banner image display a game screen from the MS-DOS F-Zero game](../../public/assets/images/app/games/msdos_monkey_island_2_lechucks_revenge.png)
        [Monkey Island 2: LeChuck's Revenge](https://en.wikipedia.org/wiki/Monkey_Island_2:_LeChuck%27s_Revenge)
    </div>
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_maniac_mansion_ii_day_of_the_tentacle.png)
        [Maniac Mansion II: Day of the Tentacle](https://en.wikipedia.org/wiki/Day_of_the_Tentacle)
    </div>
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_the_settlers.png)
        [The Settlers](https://en.wikipedia.org/wiki/The_Settlers) (german: Die Siedler)
    </div>
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_x-com_ufo_defense.png)
    ...
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_pizza_connection.png)
        [Pizza Connection](https://en.wikipedia.org/wiki/Pizza_Tycoon) (Pizza Tycoon in the US)
    </div>
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_theme_park.png)
        [Theme Park](https://en.wikipedia.org/wiki/Theme_Park_(video_game))
    </div>
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_the_clue.png)
        [The Clue!](https://en.wikipedia.org/wiki/The_Clue!) (german: Der Clou!) The mix of genres in this game was what I liked most, the first part was like classical adventure game in which you were wandering through the city of London trying to recruit members for your crew but there was also a second part that was a strategy-like top-down view of buildings and it was used plan and later execute burglaries
    </div>
    <div>
        ![banner image display a game screen from the MS-DOS Star Fox game](../../public/assets/images/app/games/msdos_star_fox.png)
