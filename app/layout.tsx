        ...
        <html lang="en" className={`${permanentMarkerFont.variable} ${vt323.variable} ${architectsDaughter.variable} ${sourceCodePro.variable}`}>
            ...
            <body>
                ...
                <footer className={styles.layoutFooter}>
                    ...
                    <p>If you find any bugs, mistakes or typos in this blog or it's content or if you want to suggest a new feature, then please use <BaseLink href="https://github.com/chrisweb/chris.lu/issues">the ticket system</BaseLink> in the chris.lu GitHub repository. Feedback, ideas and suggestions are appricated, please do so by using the <BaseLink href="https://github.com/chrisweb/chris.lu/discussions">discussion board</BaseLink> in the chris.lu GitHub repository.</p>
