...
<section id="web_development" className="middle">
    <h1 className="h1">Web development&nbsp;<picture><source srcSet="/assets/images/noto_emoji_animated/rocket_46.webp" /><img src="/assets/images/noto_emoji_animated/rocket_46.gif" alt="flying rocket icon" height="46" width="46" /></picture></h1>
    ## Tutorials
    <div className="grid">
