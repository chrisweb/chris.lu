...
<section id="web_development" className="middle">
    <h1 className="h1">Web development&nbsp;<picture><source srcSet="/assets/images/noto_emoji_animated/rocket_32.webp" /><img src="/assets/images/noto_emoji_animated/rocket_32.gif" alt="waving hand icon" className="animatedEmoji" /></picture></h1>
    ## Tutorials
    <div className="grid">
