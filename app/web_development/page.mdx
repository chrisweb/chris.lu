...
import gifRocketStaticImport from '/public/assets/images/noto_emoji_animated/46/rocket.gif'
import webpRocketStaticImport from '/public/assets/images/noto_emoji_animated/46/rocket.webp'
