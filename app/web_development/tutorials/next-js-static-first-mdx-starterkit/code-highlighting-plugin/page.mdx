---
title: Code highlighting plugin - Next.js 15 Tutorial - Next.js 15 Tutorial
...
modified: 2025-03-08T23:00:00.000Z
...
```shell
npm i rehype-pretty-code shiki@2.5.0 --save-exact
```

> [!WARN]  
> the latest shiki version **3** includes some [breaking changes](https://shiki.matsu.io/blog/v3), which is why shiki v3.x is currently **NOT** compatible with the latest rehype-pretty-code (0.14.0)
>
> ```shell
> SyntaxError: The requested module 'shiki' does not provide an export named 'getHighlighter'
> ```
>  
> there is however a [rehype-pretty-code PR (#257) in the works](https://github.com/rehype-pretty/rehype-pretty-code/pull/257)
>  
> this is why the above npm install command uses shiki v2.5.0 which is the latest shiki version that is supported by rehype-pretty-code
