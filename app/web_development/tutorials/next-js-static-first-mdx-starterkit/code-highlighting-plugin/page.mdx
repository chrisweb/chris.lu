...
![tell the code block to highlight the "greeting" characters but only the second occurrence](../../../../../public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/rehype-pretty-code_plugin_highlight_characters_but_only_second_occurence.png)
