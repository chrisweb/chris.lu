...
```shell
npm i remark-frontmatter@latest remark-mdx-frontmatter@5.0.0 --save-exact
```

> [!WARN]  
> there is a [breaking change](https://github.com/remcohaszing/remark-mdx-frontmatter/issues/17) in remark-mdx-frontmatter v5.1.0, for now it is recommend to stay on v5.0.0, which is why in the command above we use **@5.0.0** and not @latest. There is an [issue (#17)](https://github.com/remcohaszing/remark-mdx-frontmatter/issues/17) you can follow if you are interested in updates  
