...
```js title=".remarkrc.mjs" showLineNumbers {17} {23} 
// presets imports
...
Line 17: we import the frontmatter plugin

Line 23: we add the frontmatter plugin to the remark lint configuration
