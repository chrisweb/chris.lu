---
title: Sitemap (google search console and bing webmaster tools) - Next.js 15 Tutorial
description: Sitemap (google search console and bing webmaster tools) - Next.js 15 static first MDX starterkit | Web development tutorials | www.chris.lu
...
permalink: https://chris.lu/web_development/tutorials/next-js-static-first-mdx-starterkit/sitemap_and_search_console
...
<Pagination
    previous={{ label: 'Production release (custom domain)', href: '/web_development/tutorials/next-js-static-first-mdx-starterkit/production_release' }}
/>
