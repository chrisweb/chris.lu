...
> [!NOTE]  
> The version (15.1.1-canary.0) that I used in my overrides is currently the latest canary (10th dec. 2024), however by the time you read this I'm sure that newer versions will be available, so you should update that version manually, to know which versions are the latest (either for the stable or the canary branch) you can have a look at the [npm versions page for Next.js](https://www.npmjs.com/package/next?activeTab=versions)  
>  
