...
```mdx title="/app/(tutorial_examples)/mdx-components_playground/page.tsx" showLineNumbers{16} /width="1200" height="750"/#special
...
Line 14 we add a comma

Lines 15 to 17: we specify that we want VSCode to treat MDX files as if they were markdown (this will not change how Next.js renders your content or disable JSX, your content will still be MDX, it just tells VSCode to activate its markdown features when editing an MDX file)
...
![image of the the VSCode drop options icon](../../../../../public/assets/images/app/web_development/tutorials/next-js-static-first-mdx-starterkit/vscode_image_drop_options_icon.png)
...
![image of the the VSCode drop options menu](../../../../../public/assets/images/app/web_development/tutorials/next-js-static-first-mdx-starterkit/vscode_image_drop_menu_option_markdown_image.png)
...
```js title="next.config.mjs" showLineNumbers {49-52}
import { withSentryConfig } from '@sentry/nextjs';
import type { NextConfig } from 'next'
import { PHASE_DEVELOPMENT_SERVER } from 'next/constants'
import createMdx from '@next/mdx'
