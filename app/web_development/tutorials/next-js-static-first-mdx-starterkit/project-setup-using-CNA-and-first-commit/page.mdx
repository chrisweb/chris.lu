...
Depending on the amount of people that will work on your project, you might want to choose a more complex strategy. If you want to learn more about branching strategies, have a look at my [Choosing a git Branching Strategy](/web_development/posts/git#choosing-a-git-branching-strategy) chapter in the git post
