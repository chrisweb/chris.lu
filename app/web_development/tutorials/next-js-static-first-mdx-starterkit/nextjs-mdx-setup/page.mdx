...
It is now possible to specify which flavor of markdown is supported, it is not listed in the [Next.js configuration page about the Rust compiler for MDX](https://nextjs.org/docs/app/api-reference/config/next-config-js/mdxRs) page but I did some tests and it worked well
