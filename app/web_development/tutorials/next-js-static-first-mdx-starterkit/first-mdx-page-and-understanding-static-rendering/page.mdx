...
One easy way to spot if a page is **static** or not, just got added in Next.js 15. If your page is static then a round toast (badge) will appear at the bottom right of your page and if you hover it, it says "Static route"
...
Another option to check what pages (routes) are **static** is to make a (local) build, using the following command:
