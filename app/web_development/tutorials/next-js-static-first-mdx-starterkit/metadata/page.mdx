---
title: Next.js 15 Metadata (for tsx and mdx pages) - Next.js 15 Tutorial
description: Next.js 15 Metadata (for tsx and mdx pages) - Next.js 15 static first MDX starterkit | www.chris.lu Web development tutorials
keywords: ['Metadata', 'tsx', 'mdx', 'pages', 'OpenGraph', 'SEO', 'nextjs']
published: 2024-12-31T23:00:00.000Z
modified: 2024-12-31T23:00:00.000Z
permalink: https://chris.lu/web_development/tutorials/next-js-static-first-mdx-starterkit/metadata
...
Line 9: the second property is the fallback title that gets used for any route that does not set its own title (which is required, when using template)
...
The `viewport` tag gets always added to every page by default, but you can customize the **content** value of the viewport by exporting a [viewport](https://nextjs.org/docs/app/api-reference/functions/generate-viewport) object:
...
<link rel="apple-touch-icon" href="/apple-icon1.png" type="image/png" sizes="152x152">
<link rel="apple-touch-icon" href="/apple-icon2.png" type="image/png" sizes="192x192">
<link rel="apple-touch-icon" href="/apple-icon3.png" type="image/png" sizes="512x512">
```
...
<Pagination
    previous={{ label: 'GitHub-like alerts using the rehype-github-alerts plugin', href: '/web_development/tutorials/next-js-static-first-mdx-starterkit/github-like-alerts-plugin' }}
    next={{ label: 'Open Graph Image(s)', href: '/web_development/tutorials/next-js-static-first-mdx-starterkit/open_graph_images' }}
/>
