...
In the [previous version of this tutorial (using Next.js 14)](/web_development/tutorials/next-js-static-first-mdx-starterkit/linting-setup-using-eslint) CNA installed ESLint v8, ESLint v8 had support for **eslintrc** (classic) configuration files, but eslintrc files are now **deprecated**.
