...
(Previously) lines 1 and 2: first we remove two Node.js module imports as we will NOT need them anymore

Line 1: we renamed the **@eslint/js** import from **js** to **eslintPlugin** for consistency (with the next plugin imports we will add soon)
