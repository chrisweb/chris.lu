...
If you use prettier you probably don't need such rules, @stylistic rules are an alternative you can use to enforce rules (and auto fix) related to coding style, like double or single quotes, default indentation options and a bunch more
