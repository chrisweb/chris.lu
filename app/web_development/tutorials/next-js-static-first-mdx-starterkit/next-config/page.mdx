...
> [!WARN]  
> tldr: There are several tickets related to problems when using next.config.ts but the good news is that there is also a PR in the works [(PR #68365)](https://github.com/vercel/next.js/pull/68365), which you should subscribe to if you want to get notified of updates
