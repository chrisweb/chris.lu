...
description: A step by step tutorial series that builds a static first Next.js 15 starterkit with MDX content, covering the project setup, MDX plugins, styling, linting, CSP and deployment
