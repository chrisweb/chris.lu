...
> [!NOTE]  
> this only works with > Next.js 15.1 (Next.js 15 and before will not have the @next/mdx/mdx-js-loader that got added in v15.1)
...
Incompatible types: if you use the typescript config, know that you will likely have a types error:
