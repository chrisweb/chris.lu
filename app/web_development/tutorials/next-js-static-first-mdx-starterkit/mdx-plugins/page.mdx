...
This page contains mostly explanations about what remark and rehype plugins are, if you prefer you can skip to the next page about [installing and using a code highlight plugin](/web_development/tutorials/next-js-static-mdx-blog/code-highlighting-plugin) (for our MDX content)
