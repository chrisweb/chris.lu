...
1. **Codemods** are great little helpers that can help you speed up the migration process by upgrading parts of your code to use the new features of a framework, which is why I recommend have a look at the [Next.js 15 codemods](https://nextjs.org/docs/app/building-your-application/upgrading/codemods) and out their official [Next.js "Upgrading: Version 15" documentation](https://nextjs.org/docs/app/building-your-application/upgrading/version-15)
1. Same for React 19, you will likely have some updates to, like converting React 18 components using forwardRef to React 19 components using the ref that is now in component props, but again to speed things up you might want to first give the codemods a try: [React 19 codemods](https://react.dev/blog/2024/04/25/react-19-upgrade-guide#codemods) and check out their official [React 19 upgrade guide](https://react.dev/blog/2024/04/25/react-19-upgrade-guide)
