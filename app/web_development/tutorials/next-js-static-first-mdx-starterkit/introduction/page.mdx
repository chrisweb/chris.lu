...
description: Introduction - Next.js 15 static first MDX starterkit | Web development tutorials | www.chris.lu
...
and if you use TypeScript, update the React and React-dom types too:
