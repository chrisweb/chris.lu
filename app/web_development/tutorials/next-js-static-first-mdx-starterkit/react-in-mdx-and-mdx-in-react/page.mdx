...
>  
> But did you know, that you can also right click inside of the File Explorer (in the primary sidebar) and then choose **New File...** and enter the whole `components/tutorial_examples/buttons/Counting.tsx` path at once, VSCode will create all of the folders as well as the file (all in one go)
