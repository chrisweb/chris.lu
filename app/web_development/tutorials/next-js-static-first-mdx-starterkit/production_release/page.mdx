...
In this tutorial, we deploy to Vercel, but there are a lot of alternatives to choose from. 

> [!TIP]  
> Next.js 15 comes with [improvements to self hosting](https://nextjs.org/blog/next-15#improvements-for-self-hosting) make it easier for you to choose an alternative to Vercel
...
First, make sure all code is committed in the preview branch

Wait for the preview to deploy on Vercel
...
I already own a domain and I see no reason why I would transfer it, as all my domains are at the same registrar and I would like to keep it like that, so I will choose **add** a domain
