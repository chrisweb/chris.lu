...
Line X: we create a new **InputPropsType**

Lines 50 to 53: we add type information to the input props, then we do a `console.log` to get an idea of what the props values are that we might get
