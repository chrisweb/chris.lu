...
>  
> Then have a look at the previous chapter ["adding and configuring remark-lint"](/web_development/tutorials/next-js-static-first-mdx-starterkit/linting-mdx-using-remark-lint#markdown-linting-using-remark-lint) to learn how to get rid of those
