...
modified: 2024-08-18T21:05:05.444Z
...
The [require-trusted-types-for](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/require-trusted-types-for) directive is a very powerful directive:
...
However I have it almost always turned off (in my side projects) as a lot of packages are incompatible with this directive and your browser console will get flooded with errors:

> 

I recommend to give it a try and to turn the **require-trusted-types-for** directive **on**, maybe start with your preview environment and then if there are no violations add it to your production builds, hopefully with your stack you won't have to disable it
