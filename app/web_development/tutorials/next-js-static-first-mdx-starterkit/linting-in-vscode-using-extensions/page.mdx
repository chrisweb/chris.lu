...
We now have [markdown as well as code linting](/web_development/tutorials/next-js-static-first-mdx-starterkit/linting-setup-using-eslint) set up 🎉, but we have no linting in VSCode itself (yet)
