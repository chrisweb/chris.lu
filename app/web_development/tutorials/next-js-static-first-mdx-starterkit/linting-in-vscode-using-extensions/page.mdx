...
permalink: https://chris.lu/web_development/tutorials/next-js-static-mdx-blog/linting-in-vscode-using-extensions
...
We now have [markdown as well as code linting](/web_development/tutorials/next-js-static-mdx-blog/linting-setup-using-eslint) set up 🎉, but we have no linting in VSCode itself (yet)
...
>  
> To have the ESLint extension support typescript configuration files, you need to add the same flag we previously added to our linting command in the package.json (in the [Linting setup using ESLint](/web_development/tutorials/next-js-static-mdx-blog/linting-setup-using-eslint) page)
>  
...
<Pagination
    previous={{ label: 'ESLint MDX plugin and remark-lint', href: '/web_development/tutorials/next-js-static-mdx-blog/eslint-mdx-plugin-and-remark-lint' }}
