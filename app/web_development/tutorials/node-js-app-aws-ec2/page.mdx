...
You will get asked some questions by the certbot cli tool, like your email address (which will get used if your certificate is about to expire and has not been automatically renewed), then you need to accept the terms and conditions, you also get asked if you want to share your email with the [Electronic Frontier Foundation](https://www.eff.org/) so that they can periodically send you mails about their work and finally it asks you to select the domains for which you want to install a certificate
...
One last important thing, as certificates are shortlived we want to have a cron that will take care of automatically update our certificate(s) periodically (when certbot detects that it is close to expering)
