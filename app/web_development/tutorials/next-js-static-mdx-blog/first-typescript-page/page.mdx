...
> [!MORE]  
> [Next.js "layouts" documentation](https://nextjs.org/docs/app/building-your-application/routing/pages-and-layouts#layouts)  
...
Now go back into your browser to have another look at the rendered page at `https://localhost:3000/`
