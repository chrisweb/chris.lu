...
In the previous part of the tutorial we added linting for our code, we did heavy changes to the linting setup which we needed to be able to start the second major linting setup, which is setting up linting for the markdown content in our MDX pages
...
Congratulations 🎉 you just added linting for all your markdown content in your projects MDX pages, if you liked this post please consider making a [donation](https://buymeacoffee.com/chriswwweb) ❤️ as it will help me create more content and keep it free for everyone
