...
## Answering some questions regarding about the linting setup
...
Congratulations if you made it this far 🎉 we had to a lot of changes, but you now know a lot more about how ESLint works and we are now ready to start adding linting for MDX content in the next part of this tutorial
