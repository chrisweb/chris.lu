...
**create next app** has added a `.eslintrc.json` in the root of our project, as we will add our own custom eslint configuration file, the first we need to do is delete the current `.eslintrc.json`
