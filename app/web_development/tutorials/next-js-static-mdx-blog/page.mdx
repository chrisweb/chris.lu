...
go to their Git repository and copy the git URL, then install it using the npm install command, for example to install [One Dark Pro for Visual Studio Code](https://github.com/Binaryify/OneDark-Pro/tree/052d61e1aeab15b15396f6e958c166950670a1d1/themes) you would use the following command:
...
However not all VSCode themes can be used out the box with shiki, some for example like [Dracula for Visual Studio Code](https://github.com/dracula/visual-studio-code/tree/e475d548db27773fa0004b252c0a4701f187fb7e/src) use yaml files to configure the VSCode colors, in this cas you need to include a yaml loader to your setup
