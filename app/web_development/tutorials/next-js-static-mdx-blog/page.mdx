...
> [!NOTE]  
> Today is the 21th of august 2024 and I have released 2/3 of the pages of this tutorial, the next pages listed here are almost done, I just need to finish setting the metadata, doing some spell checking, verify that the code examples work as intended, ... I will release the next pages over the course of the next days, every time a page is done I will release it
