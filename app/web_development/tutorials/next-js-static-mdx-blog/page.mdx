...
```mdx title="/app/tutorial_examples/mdx-components_playground/page.tsx" showLineNumbers {16}#special
<article>
...
```tsx title="/components/base/Image.tsx" showLineNumbers {4-33}
import Image from 'next/image'
import type { ImageProps } from 'next/image'
...
```mdx title="/app/tutorial_examples/mdx-components_playground/page.tsx" showLineNumbers /{ banner }/#special
<article>
...
As you probably noticed the image is way to big, this is because right now the height and width are set to the original dimensions of the image, however we want to display a smaller version of the image and this is why we will add some CSS to limit the potential width of the image
