...
![screenshot showing the Cache-Control header having max-age set to zero and must-revalidate](../../../../public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/chrome_dev_tools_response_headers_cache.png)
...
![screenshot showing the Cache-Control header having max-age set to high value and immutable](../../../../public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/chrome_dev_tools_response_headers_cache_control_fixed.png)
...
![screenshot showing the Content-Disposition and Content-Type headers for a webp image](../../../../public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/chrome_dev_tools_response_headers_content_type_and_disposition.png)
...
![screenshot showing the Content-Disposition and Content-Type headers for an avif image](../../../../public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/chrome_dev_tools_response_headers_content_type_image_avif.png)
...
As you probably noticed the image is way to big, this is because right now the height and width are set to the original dimensions of the image, however we want to display a smaller version of the image



```tsx title="/components/base/Image.tsx" showLineNumbers{35} {11-15}
const BaseImage: React.FC<ImageProps> = (props): JSX.Element => {
