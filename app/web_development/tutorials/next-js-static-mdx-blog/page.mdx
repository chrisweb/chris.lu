...
```css title="/app/global.css" showLineNumbers{121} {1-6} {7-10} {11-13}
...
On its website the **rehype-pretty-code** plugin author recommends to add some more CSS if you want to display line numbers on the left in your code blocks:
