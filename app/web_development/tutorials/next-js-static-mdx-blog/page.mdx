...
Spoler alert! I will use css modules in this tutorial for reasons I will explain the next chapter

![banner showing in which sponge bob and patrick panic, asking "Why not UI library name here?"](public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/spongebob_panic_ui_library_meme.png)
