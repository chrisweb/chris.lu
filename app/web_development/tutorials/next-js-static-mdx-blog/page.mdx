...
> [!WARN]  
> I add a warning here as this is something I misunderstood when first using the remark-gfm tasklist, you see the feature is called tasklist and NOT for example tasks or checkboxes
>
> What this means is that the following syntax `[ ]` and `[x]` with the list syntax is NOT going to generate a checkbox, for example:
>  
> ```md
> [ ] a checkbox
> ```
>  
> This is NOT going to render a checkbox
>  
> So when using tasklists you need to use the exact syntax that remark-gfm expects, which is:
>
> ```md
> * [ ] a task
> ```
...
It is however possible to customize the **checkboxes** of a **tasklist**
