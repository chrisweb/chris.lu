...
Line 51 to 53 for any input element, we do a `console.log` to get an idea of what the props of an input element are
...
Line 52 we remove the previous code and use our checbox component instead
...
Line 56 to 59 we added the options for the footnotes to the **remarkRehypeOptions** object and NOT (as one might assume) to the **remarkGfmOptions** object (at line 46 to 48)
