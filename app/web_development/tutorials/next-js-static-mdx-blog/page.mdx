...
Now launch dev server (using the `npm run dev` command) and then visit [http://localhost:3001/tutorial_examples/mdx-components_playground](http://localhost:3001/tutorial_examples/mdx-components_playground) in your browser to see the result
