...
Line 20 to 21 we add an example for footnotes
...
Congratulations 🎉 you now have Alerts similar to what GitHub has and thx to remark-gfm you now also have support for most of the other features GitHub flawored markdown (GFM) has to offer
...
## pages (and layout) metadata

### Next.js metadata extraction from frontmatter

## GitHub production branch merge

### automatically close GitHub issues (tickets)

## going into production (using Vercel)
