...
Now we need create a new project on Sentry.io (if you need help with that step, check out my chapter [Add a new project](/web_development/posts/sentry-io#add-a-new-project-repository) in the Sentry.io post)
