...
frontmatter for Next.js metadata

because we are using MDX pages in this tutorial, maybe you are using MDX or markdown content you had created for another tool and maybe your pages / documents have frontmatter to define a pages metadata, in that case it is possible to keep the frontmatter and use it for the Next.js metadata

first we need to install 2 plugins:

[remark-frontmatter](https://github.com/remarkjs/remark-frontmatter)

this plugin will parse the frontmatter, without this plugin a MDX page with frontmatter would just display the frontmatter as text, after enabling this plugin the frontmatter part will not show up in your MDX pages anymore

[remark-mdx-frontmatter](https://github.com/remcohaszing/remark-mdx-frontmatter)

the second plugin is important as it will put the parsed frontmatter values into a variable which by default is called frontmatter but you can change the name using the options of the plugin 
...
now if you want to go a step further and also add linting for the frontmatter part, then add this plugin
