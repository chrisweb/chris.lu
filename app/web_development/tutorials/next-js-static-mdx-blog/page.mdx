...
This is a little introduction if you are not yet familiar with two new features called **server components** and **server actions** in React and Next.js, it is NOT a deep dive but a little bit of history about what evolutions took place in the React or Next.js ecosystems in the last +-2 years, so if you did not build a project with Next.js 13/14 yet I recommend you check it out, but if you are already an expert feel free to skip this chapter 😉
