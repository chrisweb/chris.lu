...
```mdx title="/app/tutorial_examples/mdx-components_playground/page.tsx" showLineNumbers{16} /width="2000" height="2000"/#special
<Image src="/images/playground_test.png" alt="purple octocat wearing a diadem, a teal dress, orange bunny slippers and holding a gaming console pad" width="2000" height="2000" />
```
...
In the previous example we have set the width and height manually, of course if you have to manage lots of images this is just bad for the DX, so what we want is to have next/image detect the width and height automatically, this is why we are going to use static imports
