...
In the global.css we just created I chose some colors, but you probably want to chose your own color palette, but if like me you are no expert in picking colors that look good together to create a color palette for your website or app, then here is a trick I often use
