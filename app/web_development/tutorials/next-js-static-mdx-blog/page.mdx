...
:root {
    --main-background-light-value: 15, 0, 25;
    --main-background-light-color: rgb(var(--main-background-value));
    --main-text-light-value: 245, 240, 245;
    --main-text-light-color: rgb(var(--main-text-value));
    --primary-light-value: ;
