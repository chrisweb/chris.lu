...
If working with colors and you need to quickly convert a color from HEX to RGB or HSL but don't want to open a heavy paint tool, just type ["color picker"](https://www.google.com/search?q=color+picker) into google search
