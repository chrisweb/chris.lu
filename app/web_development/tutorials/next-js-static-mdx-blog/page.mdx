...
So instead you need to use **mdx/remark** for **ANY** rule you want to disable

In MDX files to add an eslint-disable comment you need to use JSX comments, like so:
