...
```js title="next.config.mjs" showLineNumbers{67} {5-6} {13-15} {45} {60}
    // CSP headers here is set based on Next.js recommendations:
    // https://nextjs.org/docs/app/building-your-application/configuring/content-security-policy
    const cspReportOnly = true;
...
While at it, lets add a 3 more security headers to our Next.js configuration, like so:

```js title="next.config.mjs" showLineNumbers{67} {2} {4-11} {25} {30-37}
