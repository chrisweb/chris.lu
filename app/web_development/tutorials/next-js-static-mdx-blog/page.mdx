...
I read this article titled ["Don’t Use ARIA Menu Roles for Site Nav"](https://adrianroselli.com/2017/10/dont-use-aria-menu-roles-for-site-nav.html), which basically says that if you can not ensure you do all the aria things right then it is better to not add any aria at all, if you check out the [w3c aria "Menu and Menubar Pattern" page](https://www.w3.org/WAI/ARIA/apg/patterns/menubar/) you will see that there are indeed a lot of rules to follow and if you do one or more wrong then you might do more harm than good, this is why as of now I decided not to add any aria, but if you like to discuss this topics then please use the [discussion board of the chris.lu repository on GitHub](https://github.com/chrisweb/chris.lu/discussions)
