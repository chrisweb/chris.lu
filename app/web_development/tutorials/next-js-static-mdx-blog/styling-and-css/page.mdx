...
modified: 2024-10-07T14:33:33.444Z
...
If you want to add more than one class, either use a package like [clsx ](https://www.npmjs.com/package/clsx) or [classnames](https://www.npmjs.com/package/classnames)

Another option to add multiple classes is to use native javascript [template literals](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals) which is what I will use in this example:
