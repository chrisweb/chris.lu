...
Lines 10 to 20: we created a Next.js metadata object and used the frontmatter variable (that holds all the key/value pairs from our frontmatter above) to populate it
