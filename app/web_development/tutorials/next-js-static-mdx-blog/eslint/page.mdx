...
however if you create a custom eslintrc and add on overrides for MDX and then use **eslint-config-next**, it will  not use the overrides you set in your custom eslint, however this is currently not possible, there is open discussion regarding that limitation: [next lint command doesn't support overrides #35228](https://github.com/vercel/next.js/issues/35228)
