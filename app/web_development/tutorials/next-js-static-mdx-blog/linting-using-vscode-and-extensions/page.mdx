...
# Linting using VSCode and extensions
...
Congratulations 🎉 you just completed your projects ESLint setup, you now have a linting command for your code as well as your MDX content, you installed 2 extensions in VSCode so that we you now also have full ESLint and MDX (markdown) linting inside of our VSCode IDE, if you liked this post please consider making a [donation](https://buymeacoffee.com/chriswwweb) ❤️ as it will help me create more content and keep it free for everyone

## Ensure linting in VSCode works as intended 
