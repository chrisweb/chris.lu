...
Congratulations you just learned how to use the **mdx-components** file 🎉 we other parts of this tutorial we will edit this file again and add several more features to it
