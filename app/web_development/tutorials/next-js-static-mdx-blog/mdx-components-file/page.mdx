...
Congratulations 🎉 you just learned how to use the **mdx-components** file, in other parts of this tutorial we will edit this file again and add several more features to it, if you liked this post please consider making a [donation](https://buymeacoffee.com/chriswwweb) ❤️ as it will help me create more content and keep it free for everyone
