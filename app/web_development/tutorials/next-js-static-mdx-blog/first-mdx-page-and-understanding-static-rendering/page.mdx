...
# First MDX page and understanding of static rendering
...
Then visit your newly created MDX page in the browser at `http://localhost:3000/tutorial_examples/first_mdx_page`

Congratulations 🎉 you just added MDX support to your Next.js project and learned how to create MDX pages

## Static rendering

Putting our content into the first MDX page instead of fetching it from a database means we have just created our static site generator with MDX support
