...
Congratulations 🎉 you now know how to check if pages are static or dynamic, which is important because the more static content you have the less work the server will need to do during runtime and this will result in pages that load blazingly fast
