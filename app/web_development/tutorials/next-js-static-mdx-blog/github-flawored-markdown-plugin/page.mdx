...
Congratulations you just added GitHub flawored markdown support to your project 🎉 and learned how to use the mdx-components file to make tasklists dynamic using your own custom checkbox component
