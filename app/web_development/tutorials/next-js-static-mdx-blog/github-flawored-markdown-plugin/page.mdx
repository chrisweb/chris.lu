...
Congratulations 🎉 you just added GitHub flawored markdown support to your project and learned how to use the mdx-components file to make tasklists dynamic using your own custom checkbox component, if you liked this post please consider making a [donation](https://buymeacoffee.com/chriswwweb) ❤️ as it will help me create more content and keep it free for everyone
