---
title: Optimizing links in MDX using next/link - Tutorial
description: Optimizing links in MDX using next/link - Next.js static MDX blog | www.chris.lu Web development tutorials
...
permalink: https://chris.lu/web_development/tutorials/next-js-static-mdx-blog/optimizing-using-next-link
...
Finally, we update our playground `page.mdx` file (that is in the `/app/tutorial_examples/mdx-components_playground` folder) with two links to showcase internal and external links, like so:
...
Now launch the dev server (using the `npm run dev` command) and then open the [http://localhost:3000/tutorial_examples/mdx-components_playground](http://localhost:3000/tutorial_examples/mdx-components_playground) playground page URL in your browser to see the result
...
<Pagination
    previous={{ label: 'The mdx-components file', href: '/web_development/tutorials/next-js-static-mdx-blog/mdx-components-file' }}
    next={{ label: 'Optimizing images in MDX using next/image', href: '/web_development/tutorials/next-js-static-mdx-blog/optimizing-using-next-image' }}
/>
