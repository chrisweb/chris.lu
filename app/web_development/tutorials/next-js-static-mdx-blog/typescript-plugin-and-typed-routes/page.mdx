...
Congratulations 🎉 you just made sure your typescript support is done correctly, which is a very important milestone before starting to code and you now alos have typed routes which will further improve your DX adding more pages to your project, if you liked this post please consider making a [donation](https://buymeacoffee.com/chriswwweb) ❤️ as it will help me create more content and keep it free for everyone
