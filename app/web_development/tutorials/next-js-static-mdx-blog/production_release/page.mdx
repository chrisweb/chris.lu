---
title: Production release - Tutorial
description: Production release - Next.js static MDX blog | www.chris.lu Web development tutorials
keywords: ['Production', 'release', 'ci/cd', 'vercel', 'deploy', 'domain', 'dns', 'nameserver', 'registrar']
published: 2024-08-26T19:19:19.444Z
modified: 2024-08-27T20:20:20.444Z
permalink: https://chris.lu/web_development/tutorials/next-js-static-mdx-blog/production_release
...
![different options on the vercel domains page](../../../../../public/assets/images/app/web_development/tutorials/next-js-static-mdx-blog/vercel_domains_page.png)
...
<Pagination
    previous={{ label: 'Analytics and Speed Insights', href: '/web_development/tutorials/next-js-static-mdx-blog/analytics_and_speed_insights' }}
    next={{ label: 'Sitemap (Google Search Console and Bing Webmaster Tools)', href: '/web_development/tutorials/next-js-static-mdx-blog/sitemap_and_search_console' }}
/>
