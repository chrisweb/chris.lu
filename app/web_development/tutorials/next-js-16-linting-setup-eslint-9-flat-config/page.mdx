...
modified: 2025-12-13T10:00:00.000Z
...
> [!NOTE]  
> We're going to use eslint-plugin-better-tailwindcss **v4** (beta), if you had this plugin installed before and are migrating to v4, then have a look at the [v4 changelog](https://github.com/schoero/eslint-plugin-better-tailwindcss/blob/v4/CHANGELOG.md#v400-beta0) as there are some breaking changes.
