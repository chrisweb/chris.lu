...
For a guide about how to disable the filter, check out the chapter about [disabling the "reports from localhost" filter](/web_development/posts/sentry-io/#disable-the-reports-from-locahost-filter) in my Sentry.io post
