...
There is an open [ticket #9199](https://github.com/getsentry/sentry-docs/issues/9199) for the documentation issue, hit the notification button if you want to get a message when there is something new
