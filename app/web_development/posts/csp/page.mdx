...
> [!MORE]  
> [MDN "CSP hashes" documentation](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/script-src#allowlisting_external_scripts_using_hashes)  
...
> [!MORE]  
> [Sentry.io "Security Policy Reporting" documentation](https://docs.sentry.io/security-legal-pii/security/security-policy-reporting/#content-security-policy)  
...
> [!MORE]  
> [Sentry.io "Content-Security-Policy reporting" documentation](https://docs.sentry.io/security-legal-pii/security/security-policy-reporting/#content-security-policy)  
