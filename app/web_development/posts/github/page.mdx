...
![a stylized depiction of the github mascot "octocat" in a futuristic city with neon sign that read GitHub and Git](../../../../public/assets/images/app/web_development/posts/github/banner.png '{ banner }')
...
GitHub has a (free) [Basics](https://github.com/pricing) plan, for developers that want to start a side project or just experiment with the service, it includes unlimited public and private repositories, 60 hours of CodeSpaces usage, 2000 execution minutes for GitHub Actions and more.
