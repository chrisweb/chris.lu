---
title: GitHub
description: My GitHub notes - creating an account and a repository, switching branches, adding a custom profile README, a sponsor link and your own custom Octocat
...
<ArticleJsonLd frontmatter={frontmatter} image="/web_development/og/posts_github/opengraph-image" />
...
To switch to another branch, click on the branches dropdown (under the repository name) and select the branch you want to switch to. In this example, I will switch to a branch I named **preview** (which is my simple git flow is the branch in which I commit code that is not ready yet to go into production)
