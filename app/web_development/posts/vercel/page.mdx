...
Then click on **Complete on Vercel** button to get back to Vercel, now you are done, you can come back to this page later and make some configuration adjustements or eventually remove the integration
