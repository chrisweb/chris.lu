...
* next they ask you to connect your git provider, I intended to connect GitHub account so I clicked on the GitHub button (or click on GitLab or Bitbuket if that is the provider hosting your code), for a guide about creating a GitHub account check out my chapter [Create a GitHub account (sign up)](/web_development/posts/github#create-an-account-sign-up) in the GitHub post
