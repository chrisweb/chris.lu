---
title: Vercel
description: My Vercel notes - creating an account, adding a new project from a repository and setting up the Sentry integration for Vercel
...
<ArticleJsonLd frontmatter={frontmatter} image="/web_development/og/posts_vercel/opengraph-image" />
