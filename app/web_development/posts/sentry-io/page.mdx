...
Before we commit / sync all the changes Sentry.io did in our project, remove the test page and the API route files that Sentry.io created to test the error logging, you will not need them anymore
