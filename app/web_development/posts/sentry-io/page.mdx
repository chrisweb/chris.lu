...
> [!TIP]  
> before using the wizard, I recommend commiting your latest changes (if you haven't already) and do a last sync before launching the sentry wizard, I had some trouble in the past because of that
...
Next you get asked to chose which Sentry Project you want to use, chose the one Sentry just created for you from the list (when using the wizard Sentry will have created a project for the SDK you chose eralier, if however you don't see a Project listed here, you can check out the [Create a Sentry.io project](#create-a-sentryio-project) to create a project first)

Now the wizard will install the dependencies
