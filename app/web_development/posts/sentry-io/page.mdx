---
title: Sentry.io
description: My Sentry.io notes - creating an account and a project, the allowed domains filter, enabling or disabling reports from localhost and migrating from Sentry v7 to v8
...
<ArticleJsonLd frontmatter={frontmatter} image="/web_development/og/posts_sentry-io/opengraph-image" />
...
* next, enter a user name for Sentry.io (you can either use your full name, or as I did, use your GitHub username, or use any display name you like, if already or later plan to work in a team, then I recommend you choose a name they will recognize)
...
> [!TIP]  
> If your content is located in the EU (or for reasons related to GDPR), you may want to choose to store your Sentry data in the EU, so when asked about your preferred **Data Storage Location** make sure you choose **European Union (EU)**; This is very important because once selected, your [data storage location](https://docs.sentry.io/organization/data-storage-location/) can't be changed
