---
title: git
description: My git notes and cheat sheet - installing git, initializing a repository, choosing a branching strategy, cloning, checking status and switching branches
...
<ArticleJsonLd frontmatter={frontmatter} image="/web_development/og/posts_git/opengraph-image" />
