...
### shortcut to return to previous branch
...
If you want to switch to another branch but have uncommited changes then either commit them or stash them away using this command:
...
And finally to restore the files use:
...
To get an overview of all branches that exist remotly and locally, what remote branches are tracked by local branches, ... use this command:
