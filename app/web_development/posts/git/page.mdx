...
I will use GitHub as the origin, but you could use any other Git cloud service, like GitLab or Bitbucket if you prefer those services
...
Then use the following command to link the remote origin to your local git setup:
