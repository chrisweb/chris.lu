...
![banner image displaying a mad scientist mixing the content of a bottle labeled markdown with the content of another bottle labeled JSX into a big bowl labeled MDX](../../../../public/assets/images/app/web_development/posts/mdx/banner.png)
...
> [!WARN]  
> I did not use contentlayer lately but I came accros a post that suggest that its [development is currently halted](https://github.com/contentlayerdev/contentlayer/issues/429), so be careful if when considering that package
