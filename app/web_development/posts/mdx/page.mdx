---
title: MDX
description: What MDX is behind the scenes - how micromark, remark and rehype turn markdown into MDAST and HAST, plus useful sources, VSCode extensions and frameworks with MDX support
...
<ArticleJsonLd frontmatter={frontmatter} image="/web_development/og/posts_mdx/opengraph-image" />
...
[remark](https://github.com/remarkjs/remark) is a tool that transforms markdown with plugins, which they explain well in their README:
