...
If you want to pin a more specific version of the repository you can do so by adding a hash symbol at the end followed by the commit id or follwed by the tag (if the author of the repository has published a tag)
