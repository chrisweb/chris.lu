...
There are several ways to clone a git (GitHub) repository in VSCode, I will describe 2 that are very similar and make use of the integrated VSCode source control tool and then 1 using the VSCode Terminal:
