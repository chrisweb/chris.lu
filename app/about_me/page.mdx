...
export const metadata = {
    title: 'About me',
    description: 'My journey as a web developer, from typing BASIC games on an Amstrad CPC and running TombRaider.net to Jamendo, Clubee and what I am building now.',
    alternates: {
...
<SectionJsonLd title={metadata.title} description={metadata.description} path="/about_me" type="AboutPage" />
