...
I ended up working several years for that company as PHP developer. Even though the company was a big luxemburgish media house, the development team was small and had a familiar atmosphere. We worked hard during the day, but I also remember playing online video games with my teammates after work, which helped reduce our stress but also helped knowing each other better. I spent a lot of my free time doing prototypes with PHP frameworks that were popular at that time, which helped me become a better developer and be knowledgable when discussing such topics at work. I started as a junior developer sometimes wondering about the imposter syndrome that a lot of developers experience at one point in their career but I left as senior devloper with increased confidence in my skills.
...
When I started at Clubee the biggest challenge was to move parts of the existing infrastructure to the cloud to help us reduce the amount of time spent deeling with devops tasks and be able to focus more on the development of new features.

Another challenge was to find a methodology to decrease the time needed, from an idea to it's release in production. It was challenging to find the perfect workflow, which is why I put a lot of effort into helping the team to be more productive by taking inspiration from well known methodologies like Scrum, Extreme Programming and Shape Up. We improved DX by updating the automatic deployment workflows, as well as our debugging and monitoring tools. 

I also spent my time helping the team chose the best technologies based on our needs, budget and the knowledge of the team members, when the COVID-19 pandemic started to impact us all, which created new chanllenges we had to overcome. We were partially ready for remote work, but adapting to full time remote work and maintaining productivity by maintaining motivation was still a challenge. I worked on improving the way the team would communicate, do brainstorming sessions or have team meetings. Having worked a lot from home myself in the past I was able to give the team tips about how to create a daily routine, avoid potential distractions that are around you when working from home and also how to stay healthy and happy. A fun change we did was to transform our in person after work events into online events, which meant everyone in the team would prepare their favorite drink(s) and snack(s) and then join the others via webcam to play online games.
