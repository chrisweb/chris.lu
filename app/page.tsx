    ...
    return (
        <>
            <section className="core">
                <h1 className={`h1 ${styles.specialHeadingMargin}`}>Hello, World!&nbsp;
                ...
                <p className={`fontBigger ${styles.specialMargin}`}>I like <Typing>Web development, Lego bricks, Music, Games, Cooking, Movies & TV shows, Memes</Typing></p>
