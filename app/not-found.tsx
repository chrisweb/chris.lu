...
export default function NotFound() {
    return (
        <section className="core">
            ...
            <p>
                <ImageAnimatedPicture avifPath="/assets/images/animated/404.avif" webpStaticImport={webpNotFoundStaticImport} fetchPriority="high" loading="eager" alt="Pulp Fiction movie scene of Vincent Vega (played by John Travolta) looking around a room" className="animatedPicture" />
            </p>
            <p>
