        ...
        <>
                ...
                <div className={styles.cassette}>
                    <div className={`${styles.face} ${styles.front}`}>
                        ...
                        <a href={creditsState.license} target="_blank" rel="noreferrer" className={styles.songTitle}>{creditsState !== null ? creditsState.name : ''} <FontAwesomeIcon icon={faCreativeCommons} color='white' /></a>
                        <a href={creditsState.artistWebsite} target="_blank" rel="noreferrer" className={styles.artistName}>{creditsState !== null ? creditsState.artistName : ''} <FontAwesomeIcon icon={faArrowUpRightFromSquare} color='white' /></a>
